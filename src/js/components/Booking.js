...
import { select, templates, settings, classNames } from '../setting.js';
...
class Booking {
  ...
  updateDOM(){
    ...
    if(
      typeof thisBooking.booked[thisBooking.date] == 'undefinde'
    ||
    typeof thisBooking.booked[thisBooking.date][thisBooking.hour] == 'undefinde'
    ){
      allAvalible = true;
    }
